...
@RestController
@RequestMapping(value = "/api/admin/judge/grades/impall", produces = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet")
public class GetIMPGrades {
